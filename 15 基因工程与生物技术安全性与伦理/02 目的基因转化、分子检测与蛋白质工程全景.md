...
```
     ...
     ▼                                                       ▼
【分子水平检测】                                         【个体水平鉴定】
 ① 染色体 DNA 是否插入目的基因                          ④ 个体是否呈现预期抗性表型
    ● 方法：PCR 扩增 或 DNA 分子杂交 (DNA 探针)              ● 接种棉铃虫 ➔ 抗虫鉴定
    ● 结果：出现特异性扩增带 / 杂交带                        ● 接种病原真菌 ➔ 抗病鉴定
             │                                               ● 喷洒草甘膦 ➔ 抗除草剂
             ▼                                               ● 盐碱地移栽 ➔ 抗盐耐旱
 ② 目的基因是否转录出 mRNA
    ● 方法：RT-PCR (逆转录 PCR) 或 分子杂交 (DNA-RNA 探针)
    ● 意义：证实转录机制启动成功
             │
             ▼
 ③ 目的基因是否翻译出蛋白质
    ● 方法：【抗原-抗体杂交技术】 (利用特定单抗检测)
    ● 意义：证实蛋白质成功翻译合成
```
...
```
  ...
  【推测应有的氨基酸序列】
          │ (逆向翻译密码子)
          ▼
  【找到并改造对应的脱氧核苷酸序列 (基因)】 或 【人工全化学合成基因】
          │ (转录与翻译)
          ▼
  【表达出满足人类需求的新型蛋白质】
```
