...
```mermaid
graph TD
    A[神经-体液-免疫调节网络] --> B[神经调节微观机理]
    A --> C[体液调节与内分泌枢纽]
    A --> D[特异性免疫防御战役]
    A --> E[免疫失调与临床应用]

    B --> B1[反射弧结构完整性 & 条件反射]
    B --> B2[静息电位 K⁺外流 vs 动作电位 Na⁺内流]
    B --> B3[突触胞吐单向传递 & 电流计指针偏转模型]

    C --> C1[主要内分泌腺与斯他林促胰液素实验]
    C --> C2[血糖平衡双向调节: 胰岛素 vs 胰高血糖素]
    C --> C3[甲状腺分级负反馈轴 & 水盐-体温平衡]

    D --> D1[三道防线与免疫细胞兵团: APC / B / T / 浆细胞]
    D --> D2[体液免疫双信号活化 & 效应抗体]
    D --> D3[细胞免疫靶细胞接触裂解(凋亡) & 二次应答]

    E --> E1[过敏反应(IgE吸附肥大细胞) vs 自身免疫病]
    E --> E2[AIDS 与 HIV 感染消长曲线分析]
    E --> E3[疫苗主动免疫 / 免疫血清 / 器官移植 HLA 配型]
```
