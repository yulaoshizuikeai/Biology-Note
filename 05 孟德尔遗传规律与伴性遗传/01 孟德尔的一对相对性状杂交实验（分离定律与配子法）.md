...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 780 370" width="100%">
  ...
  <g transform="translate(20, 72)">
    ...
    <g transform="translate(15, 48)">
      ...
      <text x="12" y="17" fill="#0369A1" font-size="11" font-weight="bold">① 发现问题：F₂ 显隐比约为 3:1</text>
      <text x="12" y="32" fill="#334155" font-size="10">纯种高矮杂交 F₁ 全为高茎；F₁ 自交 F₂ 恒现 3:1 性状分离</text>
      <!-- 假说 -->
      <g transform="translate(0, 46)">
        <rect x="0" y="0" width="330" height="44" rx="6" fill="#FEFCE8" stroke="#FEF08A" stroke-width="1"/>
        <text x="12" y="17" fill="#854D0E" font-size="11" font-weight="bold">② 作出假说：核心是【成对遗传因子彼此分离】</text>
        <text x="12" y="32" fill="#4B5563" font-size="10">成对遗传因子随配子形成而分离，配子只含其一，雌雄随机结合</text>
      </g>
      <!-- 演绎 -->
