...
- **类胡萝卜素（约占 $1/4$）**：
  - **胡萝卜素（橙黄色）**与**叶黄素（黄色）**；
  - 主要吸收**蓝紫光**。
- _现象解释_：绿光由于几乎不被叶绿素和类胡萝卜素吸收，大部分被反射出来，因此叶片呈现绿色。
...
- **微观生化过程**：
  ...
  2. **$C_3$ 的还原与 $C_5$ 的再生**：在有关酶催化下，$C_3$ 接受 **$\text{ATP}$ 释放的能量**并被 **$\text{NADPH}$ 还原（提供氢和能量）**，一部分转化为储存能量的糖类有机物 $(CH_2O)$，另一部分经过一系列复杂的生化反应重新再生为 $C_5$（该过程亦需消耗 ATP），维持卡尔文循环的持续运转：
     $$2C_3 + 2\text{NADPH} + 3\text{ATP} \xrightarrow{\text{酶}} (CH_2O) + C_5 + 2\text{NADP}^+ + 3\text{ADP} + 3\text{Pi}$$
  ...
  <g transform="translate(20, 72)">
    ...
    <g transform="translate(15, 48)">
      ...
      <g transform="translate(0, 100)">
        ...
        <text x="12" y="49" fill="#2563EB" font-size="10" font-weight="bold">● C₃ 还原：2 C₃ + 2 NADPH + 3 ATP ➔ (CH₂O) + C₅</text>
      </g>
      <!-- 关键禁区警示 -->
...
- **微观本质剖析**：
  ...
  - 这些 ATP **仅在叶绿体基质中用于暗反应（包括 $C_3$ 的还原与 $C_5$ 的再生）**；
