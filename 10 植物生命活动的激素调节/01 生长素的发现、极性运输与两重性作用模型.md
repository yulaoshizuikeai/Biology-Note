...
- **前体原料**：在细胞质基质中，由**色氨酸（Tryptophan）**经过一系列酶促脱羧、氧化反应转变而来（注：生长素为小分子有机物，而非蛋白质，不在核糖体合成）。
...
- **发生部位**：仅发生在植物的**幼嫩感受部位**（如胚芽鞘尖端、根冠/根尖感受重力部位）。
- **诱发动力**：
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 780 370" width="100%" height="100%">
  ...
  <g transform="translate(20, 72)">
    ...
    <text x="25" y="185" font-size="10.5" font-weight="bold" fill="#0f172a">达尔文实验严密对照结论与推论：</text>
    ...
    <text x="25" y="240" font-size="9.5" fill="#047857" font-weight="bold">③ 假说：尖端受光向伸长区传递【某种影响】促使背光面长得快。</text>
  </g>
  <!-- 右侧：三大器官两重性敏感度曲线 -->
